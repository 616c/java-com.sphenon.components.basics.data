...
public class Factory_VectorAdapter1ToN<T1,T2> {


    public Factory_VectorAdapter1ToN(CallContext context) {
    }

    public VectorAdapter1ToN<T1,T2> create (CallContext context) {
        return new VectorAdapter1ToN<T1,T2>(context, this.component_type, this.conversion_manager, this.source_vector, this.additional_arguments);
    }
    ...
    protected ConversionManager1ToN<T2,T1> conversion_manager;

    public void setConversionManager(CallContext context, ConversionManager1ToN<T2,T1> conversion_manager) {
