...
public class ConversionManagerVolatile<T2,T1>
    implements ConversionManager<T2,T1>
{
    protected ConversionManagerVolatile(CallContext context) {
    }

    static public<T2,T1> ConversionManagerVolatile<T2,T1> get(CallContext context) {
        return new ConversionManagerVolatile<T2,T1>(context);
    }
