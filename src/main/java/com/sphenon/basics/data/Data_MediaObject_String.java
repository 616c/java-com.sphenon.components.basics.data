...
public class Data_MediaObject_String implements Data_MediaObject {
    private String text;
    ...
    static public Data_MediaObject_String create(CallContext context, String text, String type_extension) {
